...
class Pokemon {
  ...
  clone(): Pokemon {
    ...
    // structuredClone Rompe las referencias
    //return new Pokemon(this.name, this.type, this.level, structuredClone(this.attacks))
    //Tambien podemos crear un nuevo arreglo con el spread
